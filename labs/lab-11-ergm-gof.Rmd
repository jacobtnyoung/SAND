---
title: "Lab 10-Simulation and Goodness of Fit with Exponential Random Graph Models (ERGMs)"
...
legend( "topright", 
        legend=c( "Bomb Maker", "Command", "Ops Asst", 
                  "Suicide Bomber", "Team Lima" ), 
        col = my.pal, pch = 19, pt.cex=2 
        )
...
# Now, simulate a network from the model.
sim.role.Bali <- simulate(role.Bali, nsim=1, warning=FALSE, seed = 605)
...
# Simulate 8 networks
sims.role.Bali <- simulate(role.Bali, nsim=8, warning=FALSE, seed = 605)

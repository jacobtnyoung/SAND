---
title: "Lab 11 - More Exponential Random Graph Models (ERGMs) in R"
...
!!!HERE: Want to work through this for the directed network

Need to add the link to lab 10 here
...
Using the coefficient of `round( homophily.gaNetU$coefficients[2], 2 )`, the predicted probability of an edge between nodes with the **same** role designation is:

...
Think about what we did on the last line. For the power influence edges, we assigned `INFO.mat` as an attribute. This represents whether a power/influence tie was **also** an informatin network tie.

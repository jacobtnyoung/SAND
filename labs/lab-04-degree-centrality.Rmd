...
gplot(
  d.mat, 
  gmode="digraph", # note the change here
  arrowhead.cex=0.5, 
  edge.col="grey40", 
...
# Then, use that information in the plot
# partition the plotting window to show two plots
par( mfrow=c( 2,1 ) )
...
gplot(
  ...
  vertex.cex = ideg.d.mat+0.2,
  vertex.col = col.ideg,
  sub="Nodes sized & shaded by Indegree"
  )
...
gplot(
  ...
  vertex.cex = odeg.d.mat,
  vertex.col = col.odeg,
  sub="Nodes sized & shaded by Outdegree"
  )

...
4. Examine and describe the relationship between degree and the attribute `Prison` of experience.
...
3. Estimate an ERGM where ties form at random. Interpret the coefficient.
4. Examine and describe the relationship between outdegree and the attribute `White` of experience.
5. Examine and describe the relationship between indegree and the attribute `White` of experience.
6. Estimate an ERGM where individuals differ in their degree based on the attribute `White`. Interpret the coefficient.
7. Estimate an ERGM where differ differ in their degree based on the attribute `YearsOnUnit`. Interpret the coefficient.
...
12. Estimate an ERGM where ties are reciprocated.
13. Simulate a network from the ERGM in #6, #7, or (and?) #9. 
14. Plot the simulated network from #12 and the `trustNet`, identifying nodes based on `White` or (and?) `YearsOnUnit` in both plots.

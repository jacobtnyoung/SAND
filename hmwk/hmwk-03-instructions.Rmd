...
5. Compare the differences for the three mean centrality scores.
6. Calculate the graph centralization for degree, closeness, and betweenness centrality.  
7. Interpret each graph centralization score.
8. Compare the differences for the three graph centralization scores.
...
3. Calculate the mean (unstandardized) indegree, outdegree, closeness, and betweenness centrality score.
4. Interpret each mean centrality score.
5. Compare the differences for the four mean centrality scores.
6. Calculate the graph centralization for indegree, outdegree, closeness, and betweenness centrality.  
7. Interpret each graph centralization score.
8. Compare the differences for the four graph centralization scores.

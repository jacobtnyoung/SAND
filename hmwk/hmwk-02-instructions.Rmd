...
In [Homework 1](../hmwk/lab-01-instructions.html) you created two networks. I would like you to continue working with those networks for *this* homework. Please review [Lab 3 - Introduction to Networks in R](../labs/lab-03-network-data.html) and [Lab 4 - Basics of Network Visualization](../labs/lab-04-description-visualization.html) prior to beginning this lab.  

Two **IMPORTANT** points:  

  + If you created a bipartite (i.e. two-mode) network in [Homework 1](../hmwk/lab-01-instructions.html) for either network, you will need to restructure the network to be unipartite for this assignment. But, this is a simple task! All you have to do is figure out which node set you want to connect and create direct connections between them. For example, if Jon and Julio both attended a Wu-Tang Clan concern, then the bipartite graph is: Jon-Event-Julio. That is, Jon and Julio are connected by the event. To make this unipartite, just remove the event such that you simply have: Jon-Julio.   
...
For this homework, you will use a .Rmd template I have created. Download the [template for this homework](../labs/templates/hmwk-02-template.zip?raw=true) prior to beginning the lab. For all the homework assignments, be sure to show both the solution for your code and write out your answers in the body text (were relevant). When you have completed your assignment, click the "Knit" button to render your `.RMD` file into a `.HTML` report. 
